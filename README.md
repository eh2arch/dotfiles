...
[![Join the chat at https://gitter.im/skwp/dotfiles](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/eh2arch/dotfiles?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)

# Personalized dotfiles. Run skwp dotfiles for the optimal experience.
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/eh2arch/dotfiles/master/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/eh2arch/dotfiles/master/install.sh`" -s ask
```
